...
public class LiveDataCallAdapterFactory extends CallAdapter.Factory {
   ...
   * requests (@bodyType is the ResponseType. It can be RecipeResponse or RecipeSearchResponse)
   *
   * <p>CHECK #1) returnType returns LIVEDATA CHECK #2) Type LiveData<T> is of ApiResponse.class
  ...
  public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
    ...
    // FYI: T is either RecipeResponse or RecipeSearchResponse in this app. But T can be anything
    // theoretically.
